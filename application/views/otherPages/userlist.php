<!DOCTYPE html>
<html lang="en">
<title>Halaman Kelola Pengguna - HIMASISTIFO</title>
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-12">
                                    <h4 class="page-title text-center">Daftar Pengguna</h4>
                                </div>
                            </div> <!-- end row -->
                        </div>
                        <!-- end page-title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">Tabel Kelola Pengguna</h4>
                                        <br>
                                        <?php 
                                        ...
                                        ?>
                                        <a class="btn btn-primary" href="<?php echo site_url('Timeline/formtambah');?>">Tambah Pengguna</a>
                                        <br>
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?php echo site_url('Timeline/formubah/'.$key['id'])?>" class="btn btn-warning btn-circle">
                                                    <i class="fas fa-pen"></i></a>
                                                <a href="<?php echo site_url('Timeline/hapustimeline/'.$key['id'])?>" class="btn btn-danger btn-circle">
