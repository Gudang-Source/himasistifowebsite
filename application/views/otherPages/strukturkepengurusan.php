                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-12">
                                    <h4 class="page-title text-center">Struktur Kepengurusan</h4>
                                </div>
                            </div> <!-- end row -->
                        </div>
                        <!-- end page-title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">Tabel Data Struktur Kepengurusan</h4>
                                        <?php 
                                            if($this->session->flashdata('msg')){
                                            echo $this->session->flashdata('msg');
                                            } 
                                        ?>
                                        <a class="btn btn-primary" href="<?php echo site_url('StrukturKepengurusan/formtambah');?>">Tambah Foto</a>
                                        <br>
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                            <?php
                                            $query = $this->db->query("SELECT * FROM kepengurusan");
                                            foreach ($query->result_array() as $row =>$key){
                                            ?>
                                            <tr>
                                                <td><?php echo $row+1;?></td>
                                                <td><img src="<?php echo base_url('upload/strukturkepengurusan/'); echo $key['nama_foto'];?>" width="200" height="200" class="d-block img-fluid mx-auto"></td>
                                                <td>
                                                <a href="<?php echo site_url('StrukturKepengurusan/formubah/'.$key['id'])?>" class="btn btn-warning btn-circle">
                                                    <i class="fas fa-pen"></i></a>
                                                <a href="<?php echo site_url('StrukturKepengurusan/hapusfoto/'.$key['id'])?>" class="btn btn-danger btn-circle">
