<!DOCTYPE html>
<html lang="en">
<title>Halaman Tambah Timeline - HIMASISTIFO</title>
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-12">
                                    <h4 class="page-title text-center">Formulir Tambah Postingan Blog</h4>
                                </div>
                            </div> <!-- end row -->
                        </div>
                        <!-- end page-title -->
                        <div class="row">
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <div class="m-b-30">
                                        <?php echo form_open_multipart('Blog/tambahblog');?>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Judul Postingan</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="text" name="judul_postingan" required/>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="summernote" type="text" name="isi_postingan"></textarea>
                                            </div>
                                        </div>
