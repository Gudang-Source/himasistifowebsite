<!DOCTYPE html>
<html lang="en">
<title>Halaman Ubah Foto Struktur Kepengurusan - HIMASISTIFO</title>
                    ...
                    <div class="container-fluid">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-sm-12">
                                    <h4 class="page-title text-center">Formulir Ubah Foto Stuktur Kepengurusan</h4>
                                </div>
                            </div> <!-- end row -->
                        </div>
                        <!-- end page-title -->
                        <div class="row">
                            <div class="col-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <div class="m-b-30">
                                        <?php echo form_open_multipart('StrukturKepengurusan/ubahfoto');?>
                                        <input type="hidden" name="id" class="form-control form-control-user" 
                                        value="<?php if(isset($strukturkepengurusan->id)){echo $strukturkepengurusan->id;}?>">
                                        <div class="form-group">
                                        <label>Foto Sebelumnya : </label><br>
                                        <img src="<?php echo base_url('upload/strukturkepengurusan/'); echo $strukturkepengurusan->nama_foto?>" width="800" height="600">
                                        </div>
                                        <div class="form-group">
